...
// -----------------------------------------------------------------------------
// 2025-06-25  Portrait 4:3 full‑width, 1:1 detect
//   • メニュー表記を 1× / 2× に変更
//   • デフォルト起動を 1× (Ultra‑Wide) に固定
// -----------------------------------------------------------------------------
(() => {
  /* === DOM === */
  ...
  /* === Init === */
  (async()=>{status.textContent='Requesting camera…';try{await populateCamSel();}catch(e){status.textContent='Camera error';console.error(e);return;}status.textContent='Loading model…';loop();})();
})();
